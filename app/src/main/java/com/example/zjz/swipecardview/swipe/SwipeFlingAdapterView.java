...
import com.example.zjz.swipecardview.R;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    public void setLeftResource(int resource) {
        leftResource = resource;
    }

    public void setRightResource(int resource) {
    ...
    private void setTopView() {
        if(getChildCount()>0){
            ...
            if(mActiveCard != null && mFlingListener != null) {
                ...
                flingCardListener = new FlingCardListener(mActiveCard,leftResource,rightResource, mAdapter.getItem(0),
...
//                                Log.e("Log", "onScroll " + progress);
                        		...
                        		mFlingListener.onScroll(mActiveCard,progress, scrollXProgress);
                            }
                        });
                // 设置是否支持左右滑
...
//            throw new NullPointerException("flingCardListener is null");
    ...
    public interface onFlingListener {
        ...
        void onScroll(View view, float progress, float scrollXProgress);
    }
